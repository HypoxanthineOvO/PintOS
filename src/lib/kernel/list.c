...
/* Remove the element of Min AUX from List and returns it. */
struct list_elem* list_pop_min(struct list* list, list_less_func* leff_function, void* aux) {
	struct list_elem* elem = list_min(list, leff_function, aux);
	list_remove(elem);
	return elem;
}

/* Remove the element of Max AUX from List and returns it. */
struct list_elem* list_pop_max(struct list* list, list_less_func* leff_function, void* aux) {
	struct list_elem* elem = list_max(list, leff_function, aux);
	list_remove(elem);
	return elem;
}
